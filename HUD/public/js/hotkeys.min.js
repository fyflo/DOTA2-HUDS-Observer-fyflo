...
!(function (e, t) {
  ...
  const b = new Map(),
    E = (e) =>
      o[e.toLowerCase()] || k[e.toLowerCase()] || e.toUpperCase().charCodeAt(0);
  function l(e) {
    t = e || "all";
  }
  function K() {
  ...
  function x(n) {
    if (void 0 === n)
      ...
      "function" == typeof e && ((t = e), (e = "")),
        s({ key: n, scope: e, method: t, splitKey: "+" });
    }
  }
  const s = (e) => {
      ...
      if (n.scope === o || "all" === n.scope) {
        ...
        for (const r in g)
          Object.prototype.hasOwnProperty.call(g, r) &&
            ((!g[r] && ~n.mods.indexOf(+r)) ||
              (g[r] && !~n.mods.indexOf(+r))) &&
            (e = !1);
        ((0 !== n.mods.length || g[16] || g[18] || g[17] || g[91]) &&
          !e &&
          "*" !== n.shortcut) ||
          ((n.keys = []),
  ...
  function C(n, t) {
    ...
    if (L.filter.call(this, n)) {
      ...
      for (const u in g)
        Object.prototype.hasOwnProperty.call(g, u) && (g[u] = n[p[u]]);
      n.getModifierState &&
        (!n.altKey || n.ctrlKey) &&
        n.getModifierState("AltGraph") &&
        (~w.indexOf(17) || w.push(17),
      ...
      if (e in v) {
        ...
        for (let e = 0; e < l; e++)
          if (
            (("keydown" === n.type && i[e].keydown) ||
              ("keyup" === n.type && i[e].keyup)) &&
            i[e].key
          ) {
            var s = i[e],
              c = s["splitKey"],
  ...
  function c(t) {
    ...
    r.findIndex((e) => {
      ...
      (({ keydownListener: o, keyupListenr: n, capture: e } = b.get(t) || {}),
      o) &&
      n &&
      ...
      return w.map((e) => {
        return (
          ...
          Object.keys(o).find((e) => o[e] === n) ||
            ((t = e), Object.keys(k).find((e) => k[e] === t)) ||
  ...
  if ("undefined" != typeof window) {
    ...
    (L.noConflict = (e) => (
      e && window.hotkeys === L && (window.hotkeys = a), L
    )),
      (window.hotkeys = L);
  }
  return L;
